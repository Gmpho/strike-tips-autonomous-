...
def race_dict_to_response(race_dict: Dict[str, Any], index: int) -> Dict[str, Any]:
    ...
    race_dict['trackCondition'] = race_dict.get('conditions', race_dict.get('trackCondition', 'Good'))
...
def check_system_resources() -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "status": "HEALTHY" if memory.percent < 85 and cpu_percent < 90 else "DEGRADED",
