...
class ModelConfig:
    ...
    CLOUD_MODELS = [
        {"id": "gemini-3-flash-preview:cloud", "name": "gemini-3-flash-preview:cloud", "input": ["text", "image"]},
        {"id": "gemma4:31b-cloud", "name": "gemma4:31b-cloud", "input": ["text"]},
        {"id": "qwen3.5:397b-cloud", "name": "qwen3.5:397b-cloud", "input": ["text"]},
        {"id": "nemotron-3-nano:30b-cloud", "name": "nemotron-3-nano:30b-cloud", "input": ["text"]},
