...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="mt-8 py-8 border-t border-white/5 bg-black/20 backdrop-blur-xl px-8 rounded-t-4xl">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-4 md:gap-8 mb-8">
          {links.map((link, idx) => (
            ...
            >
              <div className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center group-hover:bg-purple-500/20 group-hover:text-purple-400 transition-colors border border-white/5 group-hover:border-purple-500/30">
                <link.icon className="w-4 h-4 opacity-60 group-hover:opacity-100" />
              </div>
              <span className="text-[10px] font-black text-slate-500 uppercase tracking-tighter group-hover:text-white transition-colors">
                {link.label}
              </span>
            </a>
          ))}
        ...
        <div className="bg-white/2 border border-white/5 rounded-2xl p-6 mb-6">
          <div className="flex flex-col lg:flex-row gap-6 items-center">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-[9px] leading-relaxed text-slate-600 font-medium mt-1">
