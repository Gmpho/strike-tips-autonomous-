    ...
    <header className="flex justify-between items-center mb-10 pointer-events-auto">
      ...
      <div className="flex items-center gap-6">
        <div className="relative group">
          ...
          <div className="relative bg-black/60 border border-white/10 rounded-2xl p-2.5 backdrop-blur-xl">
        ...
        <div className="flex flex-col">
          <div className="flex items-center gap-3">
            <h1 className="text-4xl font-black tracking-tighter bg-linear-to-r from-white via-white to-slate-500 bg-clip-text text-transparent">
              STRIKE TIPS
            </h1>
      ...
      <div className="flex items-center gap-8">
        <div className="relative hidden xl:flex items-center group">
          <Search className="absolute left-4 w-4 h-4 text-slate-500 group-focus-within:text-purple-400 transition-colors" />
          <input 
            type="text" 
            placeholder="Search Intelligence..." 
            className="bg-white/5 border border-white/10 rounded-2xl pl-12 pr-6 py-3.5 text-sm font-bold w-64 focus:outline-hidden focus:border-purple-500/50 focus:bg-purple-500/5 transition-all"
          />
        </div>
        ...
        <div className="bg-white/5 border border-white/10 px-5 py-3 rounded-2xl backdrop-blur-2xl flex items-center gap-4 hover:border-white/20 transition-all cursor-pointer group">
          <div>
            <div className="text-[9px] font-black text-slate-500 uppercase mb-0.5 tracking-tighter">Active Capital</div>
            <div className="text-sm font-mono font-black text-white group-hover:text-purple-400 transition-colors">
