  ...
  return (
    ...
    >
          ...
          <div className="relative flex items-start gap-4">
            ...
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <h1 className="text-2xl md:text-3xl font-black tracking-tight text-theme-primary">Privacy Policy</h1>
              </div>
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                ...
                <span className="text-[10px] px-2.5 py-1 bg-white/5 border border-white/10 rounded-full font-bold uppercase tracking-widest text-theme-secondary">South Africa</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <motion.div variants={fadeUp} className="mb-8">
        ...
        <div className="mb-4">
          <div className="text-xs font-black text-theme-secondary uppercase tracking-widest mb-3">Information You Provide</div>
            ...
            {DATA_COLLECTED.map((item, i) => {
              ...
              return (
                <div key={i} className={`flex items-start gap-3 p-4 rounded-xl border ${colorMap[item.color]}`}>
                  ...
                  <div>
                    <div className="text-sm font-bold text-theme-primary">{item.label}</div>
                    <div className="text-xs text-theme-secondary mt-0.5">{item.desc}</div>
                  </div>
                </div>
              );
            })}
        ...
        <div>
          <div className="text-xs font-black text-theme-secondary uppercase tracking-widest mb-3">Generated by the System</div>
          ...
          <table className="w-full min-w-[400px]">
            <thead>
              <tr className="border-b border-white/10 bg-white/3">
                <th className="text-left px-4 py-3 text-[10px] font-black uppercase tracking-widest text-theme-secondary">Processing Activity</th>
                <th className="text-left px-4 py-3 text-[10px] font-black uppercase tracking-widest text-theme-secondary">Lawful Basis (POPIA §11)</th>
              </tr>
            </thead>
            <tbody>
              {[
                ...
                <tr key={i} className="border-b border-white/5 hover:bg-white/3 transition-colors">
                  <td className="px-4 py-3 text-sm text-theme-primary">{activity}</td>
      ...
      <motion.div variants={fadeUp} className="mb-8">
        ...
        <div className="overflow-x-auto rounded-xl border border-white/10">
          <table className="w-full min-w-[400px]">
            <thead>
              <tr className="border-b border-white/10 bg-white/3">
                <th className="text-left px-4 py-3 text-[10px] font-black uppercase tracking-widest text-theme-secondary">Data Type</th>
                <th className="text-left px-4 py-3 text-[10px] font-black uppercase tracking-widest text-theme-secondary">Period</th>
                <th className="text-left px-4 py-3 text-[10px] font-black uppercase tracking-widest text-theme-secondary">Deletion Trigger</th>
              </tr>
            </thead>
            <tbody>
              {RETENTION.map((row, i) => (
                <tr key={i} className="border-b border-white/5 hover:bg-white/3 transition-colors">
                  <td className="px-4 py-3 text-sm text-theme-primary">{row.type}</td>
                  <td className="px-4 py-3 text-xs font-bold text-cyan-400">{row.period}</td>
                  <td className="px-4 py-3 text-xs text-theme-secondary">{row.trigger}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <motion.div variants={fadeUp} className="mb-8">
        ...
        <div className="overflow-x-auto rounded-xl border border-white/10">
          <table className="w-full min-w-[500px]">
            <thead>
              <tr className="border-b border-white/10 bg-white/3">
                <th className="text-left px-4 py-3 text-[10px] font-black uppercase tracking-widest text-theme-secondary">Processor</th>
                <th className="text-left px-4 py-3 text-[10px] font-black uppercase tracking-widest text-theme-secondary">Purpose</th>
                <th className="text-left px-4 py-3 text-[10px] font-black uppercase tracking-widest text-theme-secondary">Location</th>
                <th className="text-left px-4 py-3 text-[10px] font-black uppercase tracking-widest text-theme-secondary">Data Shared</th>
              </tr>
            </thead>
            <tbody>
              {PROCESSORS.map((row, i) => (
                <tr key={i} className="border-b border-white/5 hover:bg-white/3 transition-colors">
                  <td className="px-4 py-3 text-sm font-bold text-theme-primary">{row.processor}</td>
                  <td className="px-4 py-3 text-xs text-theme-secondary">{row.purpose}</td>
                  <td className="px-4 py-3 text-xs text-blue-400 font-medium">{row.location}</td>
                  <td className="px-4 py-3 text-xs text-theme-secondary">{row.data}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          {YOUR_RIGHTS.map((item, i) => (
            <div key={i} className="flex items-start gap-3 p-3 rounded-xl bg-white/3 border border-white/8 hover:border-amber-500/20 transition-all">
              ...
              <div>
                <div className="text-sm font-bold text-theme-primary">{item.right}</div>
                <div className="text-xs text-theme-secondary mt-0.5">{item.desc}</div>
              </div>
            </div>
          ))}
      ...
      <motion.div variants={fadeUp}>
        <div className="p-4 rounded-xl bg-white/3 border border-white/10">
          <h2 className="text-sm font-black text-theme-primary mb-3">Contact & Regulator</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              return (
                <div key={i} className="flex items-center gap-3 p-3 rounded-xl bg-white/3 border border-white/8">
                  ...
                  <div>
                    <div className="text-[10px] text-theme-secondary uppercase font-black tracking-widest">{item.label}</div>
                    <div className="text-sm font-bold text-theme-primary">{item.value}</div>
                  </div>
                </div>
              );
            })}
