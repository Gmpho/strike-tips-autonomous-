  ...
  return (
    ...
    >
        ...
        <div className="relative overflow-hidden rounded-2xl border border-emerald-500/20 bg-gradient-to-br from-emerald-500/10 via-emerald-500/5 to-transparent p-6 md:p-8">
          <div className="relative flex items-start gap-4">
            <button
              ...
              aria-label="Go back"
              className="mt-1 p-2 rounded-xl bg-white/5 hover:bg-emerald-500/10 text-theme-secondary hover:text-emerald-400 transition-all border border-white/10 shrink-0"
            >
              <ArrowLeft size={18} />
            </button>
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <h1 className="text-2xl md:text-3xl font-black tracking-tight text-theme-primary">Betting Rules</h1>
              </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {BANKROLL_LIMITS.map((limit, i) => (
            ...
            >
              ...
              <div className="text-xs font-bold text-theme-primary mb-0.5">{limit.label}</div>
              <div className="text-[10px] text-theme-secondary">{limit.note}</div>
            </motion.div>
          ))}
        </div>
      </motion.div>
      ...
      <motion.div variants={fadeUp} className="mb-8">
        ...
        <p className="text-xs text-theme-secondary mb-4">A paper trade is only recorded when ALL conditions are met:</p>
      ...
      <motion.div variants={fadeUp} className="mb-8">
        ...
        <div className="space-y-3">
          <div className="p-4 rounded-xl bg-black/40 border border-white/10 font-mono text-sm">
            <div className="text-[10px] text-theme-secondary uppercase tracking-widest mb-3 font-sans font-bold">Formula</div>
          ...
          <div className="p-4 rounded-xl bg-emerald-500/5 border border-emerald-500/20">
            ...
            <div className="font-mono text-xs space-y-1 text-theme-primary">
              ...
              <div className="text-theme-primary font-bold">Final = R48</div>
            </div>
          </div>
        </div>
      </motion.div>
      ...
      <motion.div variants={fadeUp} className="mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          {PERFORMANCE_METRICS.map((item, i) => (
            <div key={i} className="flex items-center gap-2 text-xs text-theme-secondary p-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          {[
            ...
            <div key={i} className="p-3 rounded-xl bg-amber-500/5 border border-amber-500/20">
              ...
              <div className="text-xs text-theme-primary leading-relaxed">{item.value}</div>
            </div>
          ))}
        </div>
      </motion.div>
      ...
      <motion.div variants={fadeUp}>
        <div className="p-5 rounded-xl bg-white/3 border border-white/10">
          <h2 className="text-sm font-black text-theme-primary mb-3 flex items-center gap-2">
